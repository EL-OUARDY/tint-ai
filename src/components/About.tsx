    ...
    <>
      <div className="text-muted-foreground mt-1 text-[0.76rem]">
        ...
        <p className="text-sm">
          ...
          improvements. Open an issue if you want to chat about bigger changes first, or just submit
          a PR if you've got something ready. All contributions welcome – let's make this thing
          better together!
        </p>
        <div className="mt-4">
          <a
